...
/*! this function is called to lock our current state and prevent timer
interrupts */
void __sthread_lock(void);

/*! this function is called to unlock our current state and allow timer
interrupts after it was locked*/
