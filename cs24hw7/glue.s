...
__sthread_lock:
        movl $1, %eax           # set our return value to default 1


        # make eax the value of our lock, and our lock equal to 1
        xchg %eax, scheduler_lock

        # xor eax with 1, to return the opposite of what scheuler_lock was
        xor $1, %eax
        ret
...
__sthread_unlock:
        movl $0, scheduler_lock   # move 0 into our scheduler_lock
        ret
